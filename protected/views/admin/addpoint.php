    ...
    <div class="form_task" id="form_task" data-myid="0">
        ...
        <!-- #section:elements.form -->
            ...
            <?php foreach ($arr as $key => $value): ?>
                ...
                <div class="group_assignedId form-group ">
                    <?php echo $form->labelEx($model, $key, array('class' => 'col-sm-2 control-label no-padding-right'));?>
                    <div class="col-sm-10">
                ...
                <?php elseif($key == 'typeId'): ?>
                <div class="form-group">
                    <?php echo $form->labelEx($model, $key, array('class' => 'col-sm-2 control-label no-padding-right'));?>
                    <div class="col-sm-10" style=" margin-bottom: 4px; padding-top: 4px;">
                        推送任务
                    </div>
                    <input type="hidden" name="Task[typeId][]" value="1">
                </div>
                <?php else: ?>
                <div class="form-group">
                    <?php echo $form->labelEx($model, $key, array('class' => 'col-sm-2 control-label no-padding-right'));?>
