<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;?>/assets/css/jquery-ui.min.css" />
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;?>/assets/css/ui.jqgrid.css" />
<div class="col-xs-12">
  <!-- PAGE CONTENT BEGINS -->
  <div class="well well-sm">
    <button type="button" class="close line-height-0" data-dismiss="alert"> <i class="ace-icon fa fa-times smaller-75"></i>
    </button>
    You can have a custom jqGrid download here:
    <a href="http://www.trirand.com/blog/?page_id=6" target="_blank">
      http://www.trirand.com/blog/?page_id=6 <i class="fa fa-external-link bigger-110"></i>
    </a>
  </div>
...
<!-- page specific plugin scripts -->
    ...
    <script src="<?php echo Yii::app()->theme->baseUrl;?>/assets/js/jqGrid/jquery.jqGrid.min.js"></script>
    <script src="<?php echo Yii::app()->theme->baseUrl;?>/assets/js/jqGrid/i18n/grid.locale-en.js"></script>
